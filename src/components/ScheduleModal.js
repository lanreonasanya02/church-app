      ...
      {isOpen && (
        ...
        >
          ...
          <motion.div
            ...
            className="relative w-[95%] md:w-[70%] max-w-5xl h-[80vh] md:h-[70vh] max-h-[700px] px-5 md:px-12 md:py-6 py-2 mx-auto bg-white dark:bg-gray-800 rounded-xl shadow-2xl grid place-items-center"
          >
            <div>
              <div className="flex justify-between items-center md:py-6 mb-3 md:mb-0">
