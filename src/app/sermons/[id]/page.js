    ...
    <>
      <div className="bg-light dark:bg-primary min-h-screen bg-cover bg-center pt-5 pb-10">
        ...
        <div className="mt-52 container mx-auto">
          <Link
            href="/"
            className="text-primary dark:text-light hover:underline hover:text-secondary px-32 flex items-center gap-2"
          >
            <GrReturn />
            Return Home
          </Link>
          ...
          {sermon ? (
            <div className="mt-20  text-primary dark:text-light px-32">
